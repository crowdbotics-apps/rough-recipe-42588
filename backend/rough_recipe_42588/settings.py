"""
Django settings for rough_recipe_42588 project.
...
ROOT_URLCONF = 'rough_recipe_42588.urls'
...
WSGI_APPLICATION = 'rough_recipe_42588.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rough_recipe_42588 API",
    "DESCRIPTION": "API documentation for rough_recipe_42588 App",
    "VERSION": "v1",
}
